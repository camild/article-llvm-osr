...
\item An extension for the IIR compiler to track the correspondence between IIR and LLVM IR objects at {\tt feval} calls
\item A helper component to insert OSR points at locations identified during the analysis pass
\item A profile-driven generator for IIR code (to replace {\tt feval} calls with direct calls)
\item A callback component invoked at OSR points to generate (or retrieve a cached version of) an optimized version of the
