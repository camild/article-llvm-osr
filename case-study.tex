...
The source code of McVM is publicly available~\cite{mcvm}; after porting it from the legacy LLVM JIT to MCJIT, we have extended it with the following components to enable the optimization of \feval\ instructions:
\begin{enumerate}
...
\item An inserter component to insert OSR points in the IR generated for IIR locations annotated during the analysis pass
