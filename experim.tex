...
Results for the unoptimized and optimized versions of the benchmarks are reported in Figure\ref{fig:code-quality-base} and \ref{fig:code-quality-O1}, respectively.
