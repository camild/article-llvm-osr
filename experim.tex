...
\begin{small}
    \begin{tabular}{ |c|c|c|c|c|c|c| }
        \cline{3-7}
        \multicolumn{2}{l|}{} & \multicolumn{2}{c|}{open OSR} & \multicolumn{3}{c|}{resolved OSR} \\ 
        \cline{3-7}
        \multicolumn{2}{l|}{} & point & create & point & \multicolumn{2}{|c|}{OSRDest generation} \\ 
        \cline{1-2} \cline{6-7}
        benchmark & IR instructions & insertion & stub & insertion & total & avg per inst \\ 
        \hline
         &  &  &  &  &  &  \\ 
