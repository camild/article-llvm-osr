...
\subsection{Results}
We now present the main results of our experimental evaluation, which are aimed at addressing the following questions:

\begin{description}
\item[Q1] How much does a never-firing OSR point impact code quality?
\item[Q2] What is the overhead of an OSR transition to the same function?
\item[Q3] What is the overhead of the \osrkit\ library for inserting OSR points?
\item[Q4] What kind of benefits can I expect [...]
\end{description}
