...
\begin{table} 
    \begin{tabular}{ |c|c|c|c|c|c|c|c|c| }
        \multicolumn{2}{l|}{} & open OSR &  &  & resolved OSR &  &  &  \\ 
        \multicolumn{2}{l|}{} & point & stub & verification & point & OSRDest & generation & verification \\ 
        benchmark & IR instructions & insertion & generation &  & insertion & total & avg per inst &  \\ 
         &  &  &  &  &  &  &  &  \\ 
    \end{tabular} 
\end{table}
