...
To interactively run a dynamic inlining experiment (see \mysection\ref{se:osr-llvm}), we provide under the folder {\small\tt tinyvm/isord} a C module {\small\tt inline.c} with an LLVM IR counterpart {\small\tt inline.ll} (generated with {\small\tt clang -S -emit-llvm -O1 inline.c}).
