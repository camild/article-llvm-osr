...
The final step to be performed before execution is native code generation for {\tt isordfrom}, {\tt isordstub}, and {\tt isordto}. \myfigure\ref{fig:isordx86-64} shows.
