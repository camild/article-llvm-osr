...
The IR code shown in this section has been generated with \osrkit, an LLVM-based library we designed to support VM builders perform OSR instrumentation of IR code\footnote{Virtual register names and labels in the LLVM-produced IR code shown in this paper have been refactored to make the code more readable.}.
