...
The IR code shown in this section has been generated with \osrkit, an LLVM-based library we prototyped. \osrkit\ was designed to support VM builders in performing OSR instrumentation of IR code\footnote{Virtual register names and labels in the LLVM-produced IR code shown in this paper have been refactored to make the code more readable.}.
