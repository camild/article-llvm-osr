...
The IR code shown in this section has been generated with \clang\ and instrumented with \osrkit, an LLVM-based library we prototyped to help VM builders implement OSR in LLVM\footnote{Virtual register names and labels in the LLVM-produced IR code shown in this paper have been refactored to make the code more readable.}.
