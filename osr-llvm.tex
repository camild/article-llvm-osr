...
The IR code shown in this section has been generated with \osrkit, an LLVM-based library we designed to support VM builders with a set of abstractions for OSR instrumentation of IR code\ifnoauthorea{\footnote{\osrkit\ is included in the accompanying artifact.}}.
